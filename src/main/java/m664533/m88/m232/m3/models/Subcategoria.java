...
/**
 * This is a model class for Subcategoria type.
 */
public class Subcategoria {
     ...
     */
    protected Subcategoria(Integer id, OptionalNullable<String> nombre) {
        this.id = id;
        this.nombre = nombre;
    }
    ...
    /**
     * Converts this Subcategoria into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Subcategoria [" + "id=" + id + ", nombre=" + nombre + "]";
    }

    /**
     * Builds a new {@link Subcategoria.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Subcategoria.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Subcategoria}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Subcategoria} object using the set fields.
         * @return {@link Subcategoria}
         */
        public Subcategoria build() {
            return new Subcategoria(id, nombre);
        }
    }
}
